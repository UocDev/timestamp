...
if (major < 18 || major >= 26) {
  ...
  console.error(`Required Node.js 18.x or higher. We make this system for safety debugger bugs unknown if use in older versions. Please download new Node or install higher Node :3`);
  process.exit(1);
}
